...
var Base = new function() { // Bootstrap scope
	...
	function inject(dest, src, enumerable, base, preserve, generics) {
		...
		function field(name, val, dontCheck, generics) {
			...
			// e.g. when explicitly reinjecting Array.prototype methods
			...
			if ((dontCheck || val !== undefined && has.call(src, name))
				...
				if (func) {
					...
					// instead.
					// LV: Removed length comparison since the Closure Compiler will optimise arguments accesses
					// by making them into actual arguments
					// LV: TODO: Sort this out
